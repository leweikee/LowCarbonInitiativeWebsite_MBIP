...
public class Electricity {
    ...
    public Electricity(int id, int userid, String address, int year, int month, double currentConsumption, double carbonFootprint, byte[] bill_img) {
        this.id = id;
        this.userid = userid;
...
public void fromDAO(ElectricityDAO dao) {
        if (dao != null) {
            this.id = dao.getId();
