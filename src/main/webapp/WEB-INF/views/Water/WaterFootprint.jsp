        ...
        <div class="row m-5">
            ...
            <div class="col-md-9 ms-auto text-end">
                <button type="button" class="px-4 p-2 rounded shadow" style="background-color: #A7C3F9; border:none;">
                    ...
                    <a href="/water/WaterHistory" style="text-decoration: none; color: black"><span class="ms-2"><b>History</b></span></a>
                </button>
        ...
        <div class="row m-5">
            ...
            <div class="col-md-4 d-flex flex-column justify-content-between">
                <div class="bg-white p-4 px-5 rounded shadow m-3 text-center"><!--current water consumption section-->
                    <img src="/images/waterConsumption.png" alt="Current Water Consumption" width="80" height="75">
                    <div class="d-flex flex-column align-items-center justify-content-center mb-3">
                        <span class="mt-2">Total Water Consumption (m<sup>3</sup>)</span>
                ...
                <button type="button" class="p-2 mx-5 m-3 rounded shadow text-center" style="background-color: #A3FF6B; border:none;"><!--download report section-->
                    ...
                    <a href="/water/WaterDownloadReport?billId=${waterBill.id}" style="text-decoration: none; color: black"><span class="ms-2"><b>Download Report</b></span></a>
                </button>
            </div>
            ...
            <div class="col-md-8">
                <div class="bg-white p-4 px-5 rounded shadow m-3"><!--details section-->
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-6">${waterBill.address}</div>
                    </div>
                    ...
                    <div class="row mb-5">
                        ...
                        <div class="col-md-6"><fmt:formatNumber value="${waterBill.currentConsumption}" pattern="0.00"/></div>
                    </div>

                    <hr>

                    <div class="row mt-4 text-end">
                        <div class="col mb-3"><b>Carbon Footprint (kg CO<sub>2</sub>): <fmt:formatNumber value="${waterBill.carbonFootprint}" pattern="0.00"/></b></div>   
                    </div>
                </div>
            </div>
        </div>
