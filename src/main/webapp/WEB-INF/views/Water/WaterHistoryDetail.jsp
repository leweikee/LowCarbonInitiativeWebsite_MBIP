...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
        ...
        <head>
            <meta charset="UTF-8">
            <title>Water View Details History</title>
        ...
        <body>
            <div id="main">
                <div class="button-container">
                    <div class="backbtn" onclick="window.location.href='/water/WaterHistory';">
                ...
                <div class="viewhistory-container">
                    ...
                    <div class="carbon-footprint-section">
                        ...
                        <p class="ms-3"><fmt:formatNumber value="${waterBill.carbonFootprint}" pattern="0.00"/></p>
                    </div>
