...
<body style="background-color: #CCF3EA">
    <div class="container-fluid"><!--button container-->
        <div class="row m-5">
            <div class="col-auto" onclick="window.location.href='/recycle/InsertRecycleConsumption';">
            ...
            <div class="col-md-9 ms-auto text-end">
                <button type="button" class="px-4 p-2 rounded shadow" style="background-color: #A7C3F9; border:none;">
                    ...
                    <a href="/recycle/RecycleHistory" style="text-decoration: none; color: black"><span class="ms-2"><b>History</b></span></a>
                </button>
            
                <button type="button" class="px-4 p-2 ms-5 rounded shadow" style="background-color: #03C043; border:none;">
        ...
        <div class="row m-5">
            ...
            <div class="col-md-4 d-flex flex-column justify-content-between">
                ...
                <button type="button" class="p-2 mx-5 m-3 rounded shadow text-center" style="background-color: #A3FF6B; border:none;"><!--download report section-->
                    ...
                    <a href="/recycle/RecycleDownloadReport?billId=${recycleBill.id}" style="text-decoration: none; color: black"><span class="ms-2"><b>Download Report</b></span></a>
                </button>
            </div>
            ...
            <div class="col-md-8">
                <div class="bg-white p-4 px-5 rounded shadow m-3"><!--details section-->
                    <h3 class="text-center mb-4 mt-2"><b>Recycle Bills</b></h3>
                    <div class="row mb-4">
                        <div class="col-md-6"><b>Address:</b></div>
                        <div class="col-md-6">${recycleBill.address}</div>
                    </div>
                    ...
                    <div class="row mb-5">
                        <div class="col-md-6"><b>Current Consumption Value (m<sup>3</sup>):</b></div>
                        <div class="col-md-6"><fmt:formatNumber value="${recycleBill.currentConsumption}" pattern="0.00"/></div>
                    </div>

                    <hr>

                    <div class="row mt-4 text-end">
                        <div class="col mb-3"><b>Carbon Footprint (kg CO<sub>2</sub>): <fmt:formatNumber value="${recycleBill.carbonFootprint}" pattern="0.00"/></b></div>   
                    </div>
                </div>
            </div>
        </div>
